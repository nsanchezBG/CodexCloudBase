...
All player-facing copy must be written in Spanish. This includes the arcade homepage, game titles, buttons, HUD labels, instructions, clues, feedback messages, accessibility labels, metadata descriptions, and any dynamic text generated by JavaScript.

Use concise, natural Spanish for Latin American players. Keep folder names and URL slugs repository-safe; they may remain lowercase ASCII, but visible titles should be Spanish.
